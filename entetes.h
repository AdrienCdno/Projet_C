...
//Fonction qui établit les paramètres de jeu
void Parametres(int *nlig, int *ncol, int *nban, int *niveau, int *next);

//Fonction qui choisit un nombre au hasard
int Hasard(int val);

//Fonction qui retourne le maximum entre 2 valeurs données
int max(int a,int b);

//Fonction qui stocke les coordonnées des cases bannies dans un tableau
...
//Fonction qui stocke les coordonnées des cases voisines pour une case à un moment donné
...
//Fonction qui permet à l'ordinateur de jouer au hasard
